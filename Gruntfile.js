...
module.exports = function( grunt ) {
	...
	grunt.initConfig({
		...
		browserify: {
			...
			build: {
				files: [
					...
					{ src: 'modules/gigs/admin/js/venue-edit.js', dest: 'modules/gigs/admin/js/venue-edit.bundle.min.js' },
		...
		less: {
			dist: {
				files: [
					...
					{ src: 'admin/less/dashboard.less', dest: 'admin/css/dashboard.min.css' },
		...
		uglify: {
			dist: {
				files: [
					...
					{ src: 'modules/gigs/admin/js/venue-edit.bundle.min.js', dest: 'modules/gigs/admin/js/venue-edit.bundle.min.js' },
		...
		makepot: {
			build: {
				options: {
					exclude: [ '.git/.*', 'dist/.*', 'includes/vendor/.*', 'node_modules/.*', 'release/.*', 'tests/.*' ],
