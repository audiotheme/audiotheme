<table class="form-table">
	<tr>
		<th><label for="venue-contact-name"><?php _e( 'Name', 'audiotheme-i18n' ) ?></label></th>
	...
	<tr>
		<th><label for="venue-contact-phone"><?php _e( 'Phone', 'audiotheme-i18n' ) ?></label></th>
	...
	<tr>
		<th><label for="venue-contact-email"><?php _e( 'Email', 'audiotheme-i18n' ) ?></label></th>
